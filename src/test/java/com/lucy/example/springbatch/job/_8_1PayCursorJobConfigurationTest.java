...
@SpringBatchTest
@SpringBootTest(classes = {_8_1PayCursorJobConfiguration.class, TestBatchConfig.class})
@TestPropertySource(properties = {"job.name=" + _8_1PayCursorJobConfiguration.JOB_NAME})
public class _8_1PayCursorJobConfigurationTest {
